    ...
    <div id="todays-weather-wrapper">
      <div className="todays-weather-container">
        ...
        <div className='todays-weather-temperature'>
          ...
          <div className="todays-temperature">{temperature == 'celsius' ? Math.round(detailOfDays[activeDay][activeHour].degree_celsius) : Math.round(detailOfDays[activeDay][activeHour].degree_fahrenheit)}<span>°</span></div>
        </div>
      </div>
